<template>
    <div :id="'reply-' + id" class="card mt-3">
            ...
            <div v-if="editing">
                <form @submit.prevent="update">
                    <div class="form-group">
                        <textarea class="form-control mb-3" v-model="body" required></textarea>
                    </div>
        ...
        <div class="card-footer level" v-if="authorize('owns', reply) || authorize('owns', reply.thread)">
            ...
            <button class="btn btn-primary btn-sm ml-auto" @click="markBestReply"
                    v-if="authorize('owns', reply.thread)">Best
                Reply
            </button>
        </div>
        <!--@endcan-->
